...
- [timkmecl/codegpt](https://github.com/timkmecl/codegpt) - VSCode extension that allows you to use GPT3 inside the IDE - 181 stars
...
- [badlogic/heissepreise](https://github.com/badlogic/heissepreise) - Jo eh. - 782 stars
