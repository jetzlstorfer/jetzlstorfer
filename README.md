...
- [mikey0000/Mammotion-HA](https://github.com/mikey0000/Mammotion-HA) - Home Assistant integration for Mammotion lawn mowers - 329 stars
- [Azure-Samples/snippy](https://github.com/Azure-Samples/snippy) - 🧩 Demo: Build AI-powered MCP Tools for GitHub Copilot using Azure Functions, OpenAI, AI Agents &amp; Cosmos DB. Manages code snippets w/ vector search. - 61 stars
- [CloudNativeStudyGroup/Free-Credly-Badges](https://github.com/CloudNativeStudyGroup/Free-Credly-Badges) - A list of free courses where you can earn Credly digital badges. Feel free to contribute! - 279 stars
- [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) - A collection of MCP servers. - 64413 stars
- [Madelena/esphome-weatherman-dashboard](https://github.com/Madelena/esphome-weatherman-dashboard) - A simple dashboard with weather and NYC subway information for ESPHome - 1149 stars
