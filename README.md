...
- [Azure-Samples/zero2hero](https://github.com/Azure-Samples/zero2hero) - This is a repo with zero 2 hero prompt engineering journeys using mostly GitHub Copilot on VS Code and Azure - 26 stars
