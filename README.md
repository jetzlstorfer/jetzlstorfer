...
- [jetzlstorfer/mygpt](https://github.com/jetzlstorfer/mygpt) -  (2 weeks ago)
...
- [keptn/keptn](https://github.com/keptn/keptn) ([1.4.1](https://github.com/keptn/keptn/releases/tag/1.4.1), 2 weeks ago) - Cloud-native application life-cycle orchestration. Keptn automates your SLO-driven multi-stage delivery and operations &amp; remediation of your applications.
...
- [timkmecl/codegpt](https://github.com/timkmecl/codegpt) - VSCode extension that allows you to use GPT3 inside the IDE - 172 stars
- [LadyKerr/mealmetrics-copilot](https://github.com/LadyKerr/mealmetrics-copilot) - Get the nutrition facts for any recipe. Built with GitHub Copilot - 31 stars
...
- [kevquirk/simple.css](https://github.com/kevquirk/simple.css) - Simple.css is a classless CSS template that allows you to make a good looking website really quickly. - 3549 stars
