...
- [jetzlstorfer/hybrid-multi-agents](https://github.com/jetzlstorfer/hybrid-multi-agents) -  (2 weeks ago)
- [jetzlstorfer/wattpilot-exporter](https://github.com/jetzlstorfer/wattpilot-exporter) - ⚡ (3 weeks ago)
...
- [Azure/git-ape](https://github.com/Azure/git-ape) - platform engineering framework for the agentic age - 252 stars
- [githubnext/monaspace](https://github.com/githubnext/monaspace) - An innovative superfamily of fonts for code - 19355 stars
