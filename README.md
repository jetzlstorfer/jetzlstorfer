...
- [jetzlstorfer/mygpt](https://github.com/jetzlstorfer/mygpt) -  (1 week ago)
...
- [timkmecl/codegpt](https://github.com/timkmecl/codegpt) - VSCode extension that allows you to use GPT3 inside the IDE - 171 stars
- [LadyKerr/mealmetrics-copilot](https://github.com/LadyKerr/mealmetrics-copilot) - Get the nutrition facts for any recipe. Built with GitHub Copilot - 27 stars
...
- [kevquirk/simple.css](https://github.com/kevquirk/simple.css) - Simple.css is a classless CSS template that allows you to make a good looking website really quickly. - 3537 stars
