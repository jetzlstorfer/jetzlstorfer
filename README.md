...
- [valentinfrlch/ha-llmvision](https://github.com/valentinfrlch/ha-llmvision) - Let Home Assistant see! - 1186 stars
...
- [redpomodoro/fronius_modbus](https://github.com/redpomodoro/fronius_modbus) - Home assistant Custom Component for reading data from Fronius Gen24 Inverter and connected smart meters and battery storage through modbus TCP. - 90 stars
- [nlweb-ai/NLWeb](https://github.com/nlweb-ai/NLWeb) - Main reference implementation for NLWeb, implemented in Python. - 6114 stars
