...
- [jetzlstorfer/spotify-yearly-discoveries](https://github.com/jetzlstorfer/spotify-yearly-discoveries) - 🎧🔍 (4 weeks ago)
...
- [Azure/git-ape](https://github.com/Azure/git-ape) - platform engineering framework for the agentic age - 232 stars
- [jetzlstorfer/hybrid-multi-agents](https://github.com/jetzlstorfer/hybrid-multi-agents) -  - 2 stars
- [githubnext/monaspace](https://github.com/githubnext/monaspace) - An innovative superfamily of fonts for code - 19170 stars
