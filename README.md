...
- [valentinfrlch/ha-llmvision](https://github.com/valentinfrlch/ha-llmvision) - Visual Intelligence for your Home. - 1228 stars
- [AzureCosmosDB/banking-multi-agent-workshop](https://github.com/AzureCosmosDB/banking-multi-agent-workshop) - A multi-agent sample and workshop for a retail banking scenario. Implemented in both C# and Python, using Angular as Frontend! - 115 stars
