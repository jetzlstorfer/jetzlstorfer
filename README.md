...
- [jetzlstorfer/spotify-yearly-discoveries](https://github.com/jetzlstorfer/spotify-yearly-discoveries) - 🎧🔍 (3 weeks ago)



#### ⭐ Latest repositories I starred

- [jetzlstorfer/lastfm-timetraveler](https://github.com/jetzlstorfer/lastfm-timetraveler) - 🧑‍🚀🎶 - 1 stars
- [Azure/git-ape](https://github.com/Azure/git-ape) - platform engineering framework for the agentic age - 230 stars
- [jetzlstorfer/hybrid-multi-agents](https://github.com/jetzlstorfer/hybrid-multi-agents) -  - 2 stars
- [githubnext/monaspace](https://github.com/githubnext/monaspace) - An innovative superfamily of fonts for code - 19150 stars
- [EmeaAppGbb/spec2cloud](https://github.com/EmeaAppGbb/spec2cloud) -  - 94 stars
