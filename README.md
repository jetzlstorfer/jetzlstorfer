...
- [alandtse/alexa_media_player](https://github.com/alandtse/alexa_media_player) - This is a custom component to allow control of Amazon Alexa devices in Home Assistant using the unofficial Alexa API. - 1741 stars
...
- [bhuebschen/lawn-mower-card](https://github.com/bhuebschen/lawn-mower-card) - Lawn Mower card for Home Assistant Lovelace UI - 10 stars
- [Azure-Samples/Apim-Samples](https://github.com/Azure-Samples/Apim-Samples) - This repository provides a playground to safely experiment with and learn Azure API Management (APIM) policies in various architectures. - 36 stars
