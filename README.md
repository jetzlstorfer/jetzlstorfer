...
- [redpomodoro/fronius_modbus](https://github.com/redpomodoro/fronius_modbus) - Home assistant Custom Component for reading data from Fronius Gen24 Inverter and connected smart meters and battery storage through modbus TCP. - 80 stars
- [nlweb-ai/NLWeb](https://github.com/nlweb-ai/NLWeb) - The main repo for NLWeb, implemented in Python. - 6053 stars
