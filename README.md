...
- [Your always up-to-date GitHub profile](https://jetzlstorfer.medium.com/your-always-up-to-date-github-profile-398b3c9d8de5?source=rss-14f716fb26f2------2) (3 years ago)
- [Automating &amp; evaluating load testing with Locust and Keptn](https://medium.com/keptn/automating-evaluating-load-testing-with-locust-and-keptn-6cf5c8f76bed?source=rss-14f716fb26f2------2) (5 years ago)
- [Running k3d and Istio locally](https://jetzlstorfer.medium.com/running-k3d-and-istio-locally-32adc5c41a63?source=rss-14f716fb26f2------2) (5 years ago)
- [Part-2: Evaluating Application Resiliency with Keptn and LitmusChaos (use-case and demo)](https://medium.com/keptn/part-2-evaluating-application-resiliency-with-keptn-and-litmuschaos-use-case-and-demo-f43b264a2294?source=rss-14f716fb26f2------2) (5 years ago)
- [Keptn — simplifying cloud-native app delivery &amp; operations — a review on our journey so far](https://medium.com/keptn/keptn-simplifying-cloud-native-app-delivery-operations-a-review-on-our-journey-so-far-5d0f56619662?source=rss-14f716fb26f2------2) (5 years ago)

#### 👷 I'm currently working on (aka my most recent contributions)

- [CloudNativeLinz/cloudnativelinz.github.io](https://github.com/CloudNativeLinz/cloudnativelinz.github.io) - Website and main repo for Cloud Native Linz community (1 day ago)
- [jetzlstorfer/podcaster](https://github.com/jetzlstorfer/podcaster) - A multi-agent pipeline that turns a research question into a ready-to-play podcast — a two-host MP3 plus AI-generated episode cover art 🎙️ (4 days ago)
- [technologieplauscherl/technologieplauscherl.github.io](https://github.com/technologieplauscherl/technologieplauscherl.github.io) - Technologieplauscherl Website (4 days ago)
- [jetzlstorfer/wattpilot-exporter](https://github.com/jetzlstorfer/wattpilot-exporter) - ⚡ (4 days ago)
- [CloudNativeLinz/go-image-generator](https://github.com/CloudNativeLinz/go-image-generator) - Generating images based on a background and some overlay images and texts (5 days ago)



#### ⭐ Latest repositories I starred

- [CloudNativeLinz/asset-generator](https://github.com/CloudNativeLinz/asset-generator) -  - 1 stars
- [jetzlstorfer/ordi-rainbach](https://github.com/jetzlstorfer/ordi-rainbach) - 🧑‍⚕️👨‍⚕️ - 1 stars
- [callifo/fronius_modbus](https://github.com/callifo/fronius_modbus) - Home assistant Custom Component for reading data from Fronius Gen24 Inverter and connected smart meters and battery storage through modbus TCP. - 62 stars
- [jetzlstorfer/VoiceAgent-Avatar-Retail](https://github.com/jetzlstorfer/VoiceAgent-Avatar-Retail) - Showcases the use of Avatar feature in tandem with Azure Voice Live API in a Retail customer scenario - 1 stars
- [jetzlstorfer/hybrid-multi-agents](https://github.com/jetzlstorfer/hybrid-multi-agents) -  - 3 stars

#### 👥 My latest followers

- [mdyusuf166](https://github.com/mdyusuf166) - MD Yousuf
- [schneidergithub](https://github.com/schneidergithub) - Aaron Schneider
- [cleot](https://github.com/cleot) - Clemens Otto
...
- [jetzlstorfer/tower-defense](https://github.com/jetzlstorfer/tower-defense)
- [jetzlstorfer/podcaster](https://github.com/jetzlstorfer/podcaster) - A multi-agent pipeline that turns a research question into a ready-to-play podcast — a two-host MP3 plus AI-generated episode cover art 🎙️
- [jetzlstorfer/hybrid-multi-agents](https://github.com/jetzlstorfer/hybrid-multi-agents)
- [jetzlstorfer/music-timetraveler](https://github.com/jetzlstorfer/music-timetraveler) - 🧑‍🚀🎶
- [jetzlstorfer/marketing-asset-creation-agent](https://github.com/jetzlstorfer/marketing-asset-creation-agent) - agentic solution for creating marketing assets based on speaker information
...
<a href="https://www.credly.com/badges/60ef7c74-59e5-49b7-814a-12b445175a26" title="Organizer - 2025 Cloud Native Community Group"><img src="https://images.credly.com/size/80x80/images/3345c743-16f5-441a-ac06-82ee980b23ab/blob" alt="Organizer - 2025 Cloud Native Community Group" width="80" height="80"></a>
